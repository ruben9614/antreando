 ...
 */
package serviciosAgregar;

import serviciosAgregar.JavonGateways;
import serviciosAgregar.InvocationAbstraction;
import serviciosAgregar.Utility;
...
public class ServletAgregar extends HttpServlet {
    ...
    static {
        METHODS = new HashMap();
        METHODS.put(new Integer(1), new JavonGateways.serviciosAgregar_LoginPhoneinsert1Gateway());
    }
