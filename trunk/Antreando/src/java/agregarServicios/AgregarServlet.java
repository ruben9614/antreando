...
import agregarServicios.JavonGateways;
import agregarServicios.InvocationAbstraction;
import agregarServicios.Utility;
...
public class AgregarServlet extends HttpServlet {
    ...
    static {
        METHODS = new HashMap();
        METHODS.put(new Integer(1), new JavonGateways.agregarServicios_LoginPhoneinsert1Gateway());
    }
